...
public class Virologus implements Leptetheto {
    ...
    /** A központi domain.Jatek (manager) objektum */
     ...
     */
    protected Mezo mostMezo;
    /**
     * A virológusra ható ágensek
     */
    protected ArrayList<Agens> agensek = new ArrayList<Agens>();
    /**
     ...
     */
    protected Anyag anyag = new Anyag();
    /**
     * A virológus által ismert genetikai kódok
     */
    protected ArrayList<Agens> ismertKodok = new ArrayList<>();
    /**
     ...
     * @param ismert_agensek Ezeket az Ágenseket fogja tudni fejből a domain.Virologus
     * @author Ákos
     */
     ...
     *
     * //@param a az az domain.Agens amit a Virologusnak el kell felejtenie
     */
    ...
    /**
     * Végigkeni az adott mezőn tartózkodó összes virológust domain.Medve ágenssel
     *
     * @author Rádai
     */
     ...
     * @return domain.Medve-e a virológus
     */
