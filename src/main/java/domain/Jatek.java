...
public class Jatek {
	...
	//private Map<Integer, domain.Virologus> virologusok;
	private Map<String, Virologus> virologusok;

	/** Milyen genetikai kódok vannak a pályán */
	protected ArrayList<Agens> kodok;
	...
	//private Map<Integer, domain.Mezo> palya;
	 ...
	 * @param field_type A mezo tipusa (0: domain.Mezo, 1: domain.Ovohely, 2: domain.Labor, 3: domain.Raktar)
