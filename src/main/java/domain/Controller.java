...
public class Controller {
    ...
    /**domain.Bena lepes prioritasa*/
    public static final int BENALEPES_PRIORITY = 30;
    /**domain.Medve lepes prioritasa*/
    ...
    /**
     * domain.Vedofelsz eldobasara szolgala parancs fuggvenye. Megnézi van-e olyan védőfelszerelése az aktív virológusnak, mint a paraméterben kapott
    ...
    public static String dropequipment(String[] args){
        ...
        switch(args[1]){
            ...
            case("balta"):
                ...
                break;
            default:
                System.out.println("Failed: domain.Vedofelsz of type "+args[1]+" doesn't exist");
                return "Failed: domain.Vedofelsz of type "+args[1]+" doesn't exist";
        }
        ...
        System.out.println("Failed: domain.Virologus doens't have this type of domain.Vedofelsz");
        return "Failed: domain.Virologus doens't have this type of domain.Vedofelsz";
    }
    ...
    public static String move(String[] args){
        ...
        Virologus v = jatek.getVirologus(vir_id);
            ...
            try {
                ...
                {
                    if(v.isBena())
                        return "Failed domain.Bena active";
                    else if(v.isMedve())
    ...
    /**
     * Visszater a domain.Virologus ID-jevel
    ...
    /**
     * Visszater az eppen aktiv domain.Virologus ID-jevel
