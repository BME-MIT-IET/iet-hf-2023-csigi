...
/**
 * Ez egy olyan domain.Lepes megvalósítás, amely a vitustánc állapotában
 * való lépést implementálja. (választ egy random szomszédos mezőt) domain.Lepes < Priorítása < domain.Bena
 *
 *
 * @author Rádai Ronald
 */
